...
import {
  ForwardMessageContentRequest,
  MessageContentRequest,
} from './mail-message-api-request';
import {
  MessageContentResponse,
  StreamingResponseBody,
} from './mail-message-api-response';
...
export class MessageDataApiService {
  ...
  ): Observable<MessageContentResponse> {
    const httpOptions = {
  ...
  getForwardMessage(
    forwardMessageContentRequest: ForwardMessageContentRequest
  ): Observable<MessageContentResponse> {
    const httpOptions = {
      headers: new HttpHeaders({
        userName: this.loginApiService.getUserName(),
  ...
  attachment(
    ...
    return this.http
      ...
      .pipe(catchError(this.handleError<any>('attachment')));
  }
}
