...
//   /api/setHtmlMode, and /api/getForward   don't existing
 ...
 constructor(
  ...
  setCc(cc  : string): Observable<string> {
    ...
    return this.http.post<string>(this.setCcUrl, "" ,  httpOptions)
      .pipe(
		  //tap(_ => this.log(`updated hero `)),
  ...
  setBody  (body  : string): Observable<string> {
    ...
    return this.http.post<string>(this.setBodyUrl, "" ,  httpOptions)
      .pipe(
		  //tap(_ => this.log(`updated hero `)),
  ...
  setBcc  (bcc  : string): Observable<string> {
    ...
    return this.http.post<string>(this.setBccUrl,"" ,  httpOptions)
      .pipe(
		  //tap(_ => this.log(`updated hero `)),
  ...
  setAutoSign  (autoSign  : string , userName:string ): Observable<string> {
	 const httpOptions = {
	  headers: new HttpHeaders({
	   ...
	   params: new HttpParams()
	   .append('autoSign', autoSign)

	};  
	  
    return this.http.post<string>(this.setAutoSignUrl, "" ,  httpOptions)
      .pipe(
		  //tap(_ => this.log(`updated hero `)),
  ...
  setAttachment  (attachment  : string  ): Observable<string> {
    ...
    return this.http.post<string>(this.setAttachmentUrl,"" ,  httpOptions)
      .pipe(
		  //tap(_ => this.log(`updated hero `)),
    ...
    return this.http.post<string>(this.sendMailBySessionModelUrl, "" , httpOptions)
      .pipe(
		  //tap(_ => this.log(`updated hero `)),
    ...
    return this.http.post<string>(this.getAttachmentUrl,"" ,  httpOptions)
      .pipe(
		  //tap(_ => this.log(`updated hero `)),
